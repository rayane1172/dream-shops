...
@EnableMethodSecurity(prePostEnabled = true) // to check role before get a ressource
...
//        configuration for spring security
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                // backend it's not related to this token anymore "statless"
                .authorizeHttpRequests(
                        auth -> auth.requestMatchers(SECURED_URLS.toArray(String[]::new)) // url accepted
                        .authenticated()
